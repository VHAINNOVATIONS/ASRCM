...
create table variable (id integer not null, display_name varchar(80) not null, help_text varchar(255), variable_key varchar(40) not null, retrieval_key varchar(40), variable_group integer not null, primary key (id));
