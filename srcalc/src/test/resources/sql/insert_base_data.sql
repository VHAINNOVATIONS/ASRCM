...
-- Cardiac Gender
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (1, 'Gender', 'gender', true, 2);
...
-- Procedure
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (3, 'Procedure', 'procedure', true, 1);
...
-- Age
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (2, 'Age', 'age', true, 2);
...
-- DNR
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (6, 'DNR', 'dnr', true, 2);
...
-- BMI
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (5, 'BMI', 'bmi', true, 3);
...
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (8, 'ASA Classification', 'asaClassification', true, 6);
...
-- Preop Pneumonia
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (7, 'Preop Pneumonia', 'preopPneumonia', true, 6);
...
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (9, 'Alkaline Phosphatase', 'alkalinePhosphatase', true, 5);
...
-- BUN Lab
INSERT INTO VARIABLE (id, display_name, variable_key, required, variable_group) VALUES (10, 'BUN', 'bun', true, 5);
