...
-- Cardiac Gender
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (1, 'Gender', 'gender', 'gender', 2);
...
-- Procedure
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (3, 'Procedure', 'procedure', 'procedure', 1);
...
-- Age
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (2, 'Age', 'age', 'age', 2);
...
-- DNR
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (6, 'DNR', 'dnr', 'dnr', 2);
...
-- BMI
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (5, 'BMI', 'bmi', 'bmi', 3);
...
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (8, 'ASA Classification', 'asaClassification', 'asaClassification', 6);
...
-- Preop Pneumonia
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (7, 'Preop Pneumonia', 'preopPneumonia', 'preopPneumonia', 6);
...
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (9, 'Alkaline Phosphatase', 'alkalinePhosphatase', 'alkalinePhosphatase', 5);
...
-- BUN Lab
INSERT INTO VARIABLE (id, display_name, variable_key, retrieval_key, variable_group) VALUES (10, 'BUN', 'bun', 'bun', 5);
